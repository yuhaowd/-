...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        globalConfig.setAuthor("余浩");    //设置作者
        ...
        packageInfo.setParent("com.zshs.messagecenter");   //设置生成的包名，与代码所在位置不冲突，二者叠加组成完整路径
        ...
        packageInfo.setServiceImpl("service.impl");
        autoGenerator.setPackageInfo(packageInfo);

        //策略设置
        StrategyConfig strategyConfig = new StrategyConfig();
        strategyConfig.setInclude("user_read_sys_outbox");  //设置当前参与生成的表名，参数为可变参数，写你的数据库表名即可
